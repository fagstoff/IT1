...
- [PHP](#php)
  ...
  - [8. Løkker](#8-l%C3%B8kker)
    ...
    - [8.2 for](#82-for)
    - [8.3 while](#83-while)
  - [9. Lese data fra URL ($_GET)](#9-lese-data-fra-url-get)
  - [10. Lese data fra HTML-skjemaer ($_POST)](#10-lese-data-fra-html-skjemaer-post)
  - [11. Lagre data fra side til side ($_SESSION)](#11-lagre-data-fra-side-til-side-session)
  - [12. Lagre data fra besøk til besøk ($_COOKIE)](#12-lagre-data-fra-bes%C3%B8k-til-bes%C3%B8k-cookie)
...
## 11. Lagre data fra side til side ($_SESSION)

**TODO**

## 12. Lagre data fra besøk til besøk ($_COOKIE)
