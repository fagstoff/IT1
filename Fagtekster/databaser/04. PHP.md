...
> ### Oppgaver
>   1. Ta utgangspunkt i siden `hallo.php` som du laget tidligere. Lag en variabel som har fornavnet ditt som verdi. Endre koden din slik at siden nå viser "Hallo [FORNAVN]". Se på String-eksemplet i koden ovenfor om du trenger hjelp.
