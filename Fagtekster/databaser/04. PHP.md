...
Dersom du har tilgang til en web-tjener med PHP, kan du teste all koden som står i denne guiden på en enkel og grei måte. Bruk HTML-koden nedenfor som en mal, og lim inn PHP-koden der hvor det er angitt.
...
Bruk malen nedenfor, og forsøk å lage et "Hallo verden"-program i PHP.
...
Variabelene i URL-en starter etter `?`, og `=` brukes for å sette en verdi til en variabel. I eksempelet over brukes også koden `%20` som gir et mellomrom.
...
For å motta alle disse variabelene, kan du bruke denne koden:
