    ...
    <form action="bestillingsmottak.php" method="post">
      ...
      <fieldset class="form-group" id="personinfo">
        ...
        <div class="form-group">
          <label class="form-control-label" for="navn">Navn</label>
          <input class="form-control mr-5" type="text" name="navn" id="validationDefault01" placeholder="Fornavn Etternavn" required />
        </div><!-- form-group -->
        <div class="form-group">
          <label class="form-control-label" for="tlf">Mobilnr.</label>
          <input class="form-control" type="text" name="tlf" id="validationDefault02" placeholder="### ## ###" />
        </div><!-- form-group -->
      </fieldset><!-- personinfo -->
